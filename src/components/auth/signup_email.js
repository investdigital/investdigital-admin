...
import { EmialsignupUser, RegisterJumptipAction } from '../../actions/auth';
import { Alert } from 'antd';
import './style/signup_email.css';
                    ...
                    <div className="login-box-body">
                        <div className="form-signin">
                            ...
                            <p className="send-email">
                                <input className="form-control form-control-email " type="text" placeholder="请输入邮箱" ref="email"/>
                                <span onClick={this.handlesend.bind(this)}>发送邮件</span>
                            </p>
...
export default connect(mapStateToProps, { EmialsignupUser, RegisterJumptipAction })(SignupEmial);
